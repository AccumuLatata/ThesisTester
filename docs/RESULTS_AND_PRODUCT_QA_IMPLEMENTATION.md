...
| `docs/DISCUSS_INTELLIGENCE_IMPLEMENTATION.md` | 🟡 DI follow-on (recovery UX + overview intent slices + expert overlay). **Must not loosen** RQ digit/path honesty gates; amends Discuss UX only via DI PRs. |
