...
portfolio / OTF); MC + `otf validation` cues sunset from residual; missing-all
batteries short-circuit before LLM; never dumps undeclared nested method trees
or substitutes `trade_summary` KPIs.
