...
**Status of this document:** Proposal under implementation. **R9–R20 are implemented** (see `docs/ENGINEERING_ROADMAP.md`); R21–R22 are not yet started. Each milestone lands as its own PR series following the repo's established regression-safe conventions (`docs/AGENT_GUIDE.md`, R1–R8 precedent).
