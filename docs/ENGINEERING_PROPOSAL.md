...
**Status of this document:** Proposal under implementation. **R9–R21 are implemented** (see `docs/ENGINEERING_ROADMAP.md`); R22 is not yet started. Each milestone lands as its own PR series following the repo's established regression-safe conventions (`docs/AGENT_GUIDE.md`, R1–R8 precedent).
