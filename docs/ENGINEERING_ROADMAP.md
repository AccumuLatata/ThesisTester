...
| Quality investigation (code + application) | `docs/QUALITY_INVESTIGATION_PLAN.md` (QI); slice reports `docs/quality/QI-00_BASELINE.md`, `QI-01_DATA_INGESTION.md`, `QI-02_LEVELS_ENGINE_PIT.md`, `QI-03_SETUP_SIGNALS_OTF.md`, `QI-04_EXECUTION_ENGINE.md`, `QI-05_ANALYTICS_VALIDATION_BATTERIES.md`, `QI-06_HEADLESS_FACADE.md`, `QI-07_STUDY_SYSTEM.md`, `QI-08_TRADE_JOURNAL.md`, `QI-09_RESEARCH_ASSISTANT_VOICE.md`, `QI-10_UI_SESSION_STATE.md`, `QI-11_TEST_SUITE_QUALITY.md`, `QI-12_TOOLING_CI_SECURITY.md`, `QI-13_DOCS_CONTRACTS_DRIFT.md`, `QI-14_PERFORMANCE_ENVELOPE.md`, `QI-15_SYNTHESIS.md` + `findings.csv` | ✅ **Completed** (investigation). Plan [#477](https://github.com/AccumuLatata/ThesisTester/pull/477); slices [#479](https://github.com/AccumuLatata/ThesisTester/pull/479)–[#494](https://github.com/AccumuLatata/ThesisTester/pull/494); fix-vs-close re-baseline [#495](https://github.com/AccumuLatata/ThesisTester/pull/495). 134 findings (0 Critical · 13 High · 90 Medium · 31 Low). The 2026-09-05 `main` CI-red precondition is **not live** (#478 restored green cells). `AUDIT_FINAL` §5 / AH §2 stay locked. Tracker: plan §8.3. Remediation is QR, not a new QI slice. |
| Quality remediation (QR) | `docs/QUALITY_REMEDIATION_PLAN.md` (QR-A…QR-G) | **In progress** (Wave 0). G-1 [#497](https://github.com/AccumuLatata/ThesisTester/pull/497) required checks live; G-2 [#498](https://github.com/AccumuLatata/ThesisTester/pull/498) constraints + Dependabot; G-3 [#501](https://github.com/AccumuLatata/ThesisTester/pull/501) one install SoT. F-1 (this row) is QI/CI docs truth. Next: F-2. |
