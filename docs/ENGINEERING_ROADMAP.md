...
| Quality remediation (QR) | `docs/QUALITY_REMEDIATION_PLAN.md` (QR-A…QR-G) | **In progress** (Wave 1). Wave 0 complete (G-1 [#497](https://github.com/AccumuLatata/ThesisTester/pull/497)–G-3 [#501](https://github.com/AccumuLatata/ThesisTester/pull/501); F-1 [#502](https://github.com/AccumuLatata/ThesisTester/pull/502)–F-3 [#504](https://github.com/AccumuLatata/ThesisTester/pull/504)). A-1 (this PR) is Policy `allow_all` H5 disclosure (QI-04-02, QI-05-09). Next: **A-2**. |
