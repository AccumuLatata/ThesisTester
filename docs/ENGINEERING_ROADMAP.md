...
| Research Study Runner | `docs/STUDY_RUNNER_IMPLEMENTATION_PLAN.md` (RS); operator `docs/STUDY_RUNNER.md` | ✅ **RS1–RS5 MVP + RS-D7 + RS6 + RS-D2 + RS-D4**; post-MVP remaining **RS-D5** (plan-locked) |
...
| RS-D5 | External Grok Bot routine pack (after RS6) ☐ **next** |
