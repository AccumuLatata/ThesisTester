...
| Research intelligence (specialist Discuss slices) | `docs/RESEARCH_INTELLIGENCE_IMPLEMENTATION.md` (RI) | 🚧 **RI-1 landed** — grid/`best SL–TP` fail-open slice + unified matcher + residual DI veto (§4.1.1); next `RI-3→RI-2→RI-4→…→RI-10`; identical RQ auditor; no engine/golden touch; series not complete until RI-10 |
