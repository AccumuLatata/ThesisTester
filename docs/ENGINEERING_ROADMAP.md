...
| Duplex intelligence (realtime content parity) | `docs/DUPLEX_INTELLIGENCE_IMPLEMENTATION.md` (DX) | 🟡 **DX-0 plan** — follow-on to DI for VA-5 full-duplex **content** parity via tool envelopes + instructions (reuse DI builders; no provider swap; no live-PCM pre-gate; voice default remains off) |
