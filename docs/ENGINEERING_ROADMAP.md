...
| Research intelligence (specialist Discuss slices) | `docs/RESEARCH_INTELLIGENCE_IMPLEMENTATION.md` (RI) | 🚧 **RI-4 landed** — grid + time + validation/WFA + single-metric fail-open slices + residual DI veto (§4.1.1); next `RI-7→…→RI-10`; identical RQ auditor; no engine/golden touch; series not complete until RI-10 |
