...
| Study Viewer (Inspect UX) | `docs/STUDY_VIEWER_IMPLEMENTATION_PLAN.md` (SV); operator `docs/STUDY_RUNNER.md` §SV | ✅ **SV0 + SV1**. Catalog + `study list` + click-to-load. SV2–SV4 not started. No in-process execute; no classic-session hydrate |
