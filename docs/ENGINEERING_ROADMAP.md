...
- `thesistester.engine.sim_core` owns immutable parent OHLC snapshots,
  one-bar bracket resolution, and the C-19 serial P7 walk / AH1 flatten
  cap. `simulate_trades` remains the sole public orchestrator of
  admission, skip/exit labels, costs, trade records, and diagnostics.
