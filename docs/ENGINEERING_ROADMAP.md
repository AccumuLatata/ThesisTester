...
| Discuss intelligence (recovery + expert framing) | `docs/DISCUSS_INTELLIGENCE_IMPLEMENTATION.md` (DI) | 🟡 **DI-1 in progress** — DI-0 merged; DI-2…DI-3 open (fail-closed numbers, fail-open discussion with negative-cue no topic-swap; no engine/golden touch) |
