...
| Quality remediation (QR) | `docs/QUALITY_REMEDIATION_PLAN.md` (QR-A…QR-G) | **In progress** (Wave 1). Wave 0 complete (G-1 [#497](https://github.com/AccumuLatata/ThesisTester/pull/497)–G-3 [#501](https://github.com/AccumuLatata/ThesisTester/pull/501); F-1 [#502](https://github.com/AccumuLatata/ThesisTester/pull/502)–F-3 [#504](https://github.com/AccumuLatata/ThesisTester/pull/504)). A-1 [#505](https://github.com/AccumuLatata/ThesisTester/pull/505) H5; A-2 [#506](https://github.com/AccumuLatata/ThesisTester/pull/506) DA1 persist. A-3 (this PR) Focus vs Admit H12 banner (QI-05-04). Next: **A-4**. |
