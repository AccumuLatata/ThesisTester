...
| Study Admit Follow-up | `docs/STUDY_ADMIT_FOLLOWUP_IMPLEMENTATION_PLAN.md` (SAF); operator `docs/STUDY_RUNNER.md` §SAF | **SAF1–SAF2 shipped** (CLI `--admit-tod auto` + Inspect **Draft Admit follow-up** → Preview). SAF3 not started. Promote without flags stays RS5. No auto-run; no ToD factor axis |
...
## Study Admit Follow-up (SAF0–SAF3) — SAF1 CLI + SAF2 Inspect draft shipped
...
| SAF2 | Inspect **Draft Admit follow-up** → Preview (no spawn; this PR) |
