...
| Level-as-anchor combination protocol | `docs/LEVEL_ANCHOR_CONFLUENCE_RESEARCH_PLAN.md` | Research protocol (docs-only). Closed token inventory + staged `core_level` × complementary partners. No new factor axes / engine / goldens |
