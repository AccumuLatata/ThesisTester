...
|---|---|---|
| Results discussion + product help | `docs/RESULTS_AND_PRODUCT_QA_IMPLEMENTATION.md` (RQ) | **Active** — RQ-0 implemented (config + corpus allowlist); RQ-1+ pending (Discuss/Help reply loops) |
