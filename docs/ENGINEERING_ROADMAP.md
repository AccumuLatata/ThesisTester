...
| Research intelligence (specialist Discuss slices) | `docs/RESEARCH_INTELLIGENCE_IMPLEMENTATION.md` (RI) | 🚧 **RI-3 landed** — grid + validation/WFA fail-open slices + residual DI veto (§4.1.1); next `RI-2→RI-4→…→RI-10`; identical RQ auditor; no engine/golden touch; series not complete until RI-10 |
