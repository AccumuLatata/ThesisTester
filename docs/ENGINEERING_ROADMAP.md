...
| Research intelligence (specialist Discuss slices) | `docs/RESEARCH_INTELLIGENCE_IMPLEMENTATION.md` (RI) | 📋 **RI-0 contract freeze** — continuation of DI: fail-open specialist/single-metric/meaning/mixed-ask slices with identical RQ auditor; no engine/golden touch; series not complete until RI-10 |
