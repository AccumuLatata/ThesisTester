...
| Discuss intelligence (recovery + expert framing) | `docs/DISCUSS_INTELLIGENCE_IMPLEMENTATION.md` (DI) | 🟡 **DI-0 plan frozen** — DI-1…DI-3 not started (fail-closed numbers, fail-open discussion with negative-cue no topic-swap; no engine/golden touch) |
