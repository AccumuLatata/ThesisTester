...
| Quality investigation (code + application) | `docs/QUALITY_INVESTIGATION_PLAN.md` (QI); slice reports `docs/quality/QI-00_BASELINE.md`, `docs/quality/QI-01_DATA_INGESTION.md`, `docs/quality/QI-02_LEVELS_ENGINE_PIT.md`, `docs/quality/QI-03_SETUP_SIGNALS_OTF.md`, `docs/quality/QI-04_EXECUTION_ENGINE.md`, `docs/quality/QI-05_ANALYTICS_VALIDATION_BATTERIES.md`, `docs/quality/QI-06_HEADLESS_FACADE.md`, `docs/quality/QI-07_STUDY_SYSTEM.md`, `docs/quality/QI-08_TRADE_JOURNAL.md`, `docs/quality/QI-09_RESEARCH_ASSISTANT_VOICE.md`, `docs/quality/QI-10_UI_SESSION_STATE.md`, `docs/quality/QI-11_TEST_SUITE_QUALITY.md`, `docs/quality/QI-12_TOOLING_CI_SECURITY.md`, `docs/quality/QI-13_DOCS_CONTRACTS_DRIFT.md`, `docs/quality/QI-14_PERFORMANCE_ENVELOPE.md`, `docs/quality/QI-15_SYNTHESIS.md` + `docs/quality/findings.csv` | ✅ **Completed** (investigation). Plan [#477](https://github.com/AccumuLatata/ThesisTester/pull/477); slices [#479](https://github.com/AccumuLatata/ThesisTester/pull/479)–[#494](https://github.com/AccumuLatata/ThesisTester/pull/494); fix-vs-close re-baseline [#495](https://github.com/AccumuLatata/ThesisTester/pull/495). 134 findings (0 Critical · 13 High · 90 Medium · 31 Low). The 2026-09-05 `main` CI-red precondition is **not live** (#478 restored green cells). `AUDIT_FINAL` §5 / AH §2 stay locked. Tracker: plan §8.3. Remediation is QR, not a new QI slice. |
| Quality remediation (QR) | `docs/QUALITY_REMEDIATION_PLAN.md` (QR-A…QR-G) | **In progress** (Wave 1). Wave 0 complete (G-1 [#497](https://github.com/AccumuLatata/ThesisTester/pull/497)–G-3 [#501](https://github.com/AccumuLatata/ThesisTester/pull/501); F-1 [#502](https://github.com/AccumuLatata/ThesisTester/pull/502)–F-3 [#504](https://github.com/AccumuLatata/ThesisTester/pull/504)). A-1 [#505](https://github.com/AccumuLatata/ThesisTester/pull/505) H5; A-2 [#506](https://github.com/AccumuLatata/ThesisTester/pull/506) DA1 persist; A-3 [#507](https://github.com/AccumuLatata/ThesisTester/pull/507) H12; A-4 [#508](https://github.com/AccumuLatata/ThesisTester/pull/508) H13; A-5 [#509](https://github.com/AccumuLatata/ThesisTester/pull/509) M9; A-6 [#510](https://github.com/AccumuLatata/ThesisTester/pull/510) M10; A-7 [#511](https://github.com/AccumuLatata/ThesisTester/pull/511) AH4 keys; A-8 [#512](https://github.com/AccumuLatata/ThesisTester/pull/512) dataset-switch TZ. A-9 [#513](https://github.com/AccumuLatata/ThesisTester/pull/513) H8 omit-means-on. A-10 [#514](https://github.com/AccumuLatata/ThesisTester/pull/514) H16 Failed section. A-11 [#515](https://github.com/AccumuLatata/ThesisTester/pull/515) H16 WFA OOS not rankable. A-12 [#516](https://github.com/AccumuLatata/ThesisTester/pull/516) DA0 Direction help=. A-13 [#517](https://github.com/AccumuLatata/ThesisTester/pull/517) H14 HTF+3c disclosure. A-14 [#518](https://github.com/AccumuLatata/ThesisTester/pull/518) Quantower primary `ingestion_mode` warning. A-15 [#519](https://github.com/AccumuLatata/ThesisTester/pull/519) expand Replay clause. A-16 [#520](https://github.com/AccumuLatata/ThesisTester/pull/520) AMP PDF ingest typed `JournalIngestError`. A-17 [#521](https://github.com/AccumuLatata/ThesisTester/pull/521) OTF matrix typed engine error. A-18 [#522](https://github.com/AccumuLatata/ThesisTester/pull/522) research bundle zip member size cap. A-19 [#523](https://github.com/AccumuLatata/ThesisTester/pull/523) assistant audit payload secret scrub. A-20 [#524](https://github.com/AccumuLatata/ThesisTester/pull/524) Backtest `pnl_points` gross alias caption. A-21 [#525](https://github.com/AccumuLatata/ThesisTester/pull/525) diagnostic-not-proof captions. A-22 [#526](https://github.com/AccumuLatata/ThesisTester/pull/526) locked-fork composer disclosure (H7/H10/H15) + F-6 Help. B-1 [#527](https://github.com/AccumuLatata/ThesisTester/pull/527) lock-the-fork tests H7/H15 (QI-04-07). B-2 [#528](https://github.com/AccumuLatata/ThesisTester/pull/528) lock-the-fork tests H10/H11 (QI-01-07). B-3 [#529](https://github.com/AccumuLatata/ThesisTester/pull/529) additive golden families default-on paths (QI-11-02). B-4 [#530](https://github.com/AccumuLatata/ThesisTester/pull/530) mutation baseline own-file asserts (QI-11-04). B-5 [#531](https://github.com/AccumuLatata/ThesisTester/pull/531) generated PIT append-future-shock 59/59 (QI-02-02). B-6 [#532] warn-first coverage floor at measured 82% (QI-12-04). B-7 [#533] `levels/common` + journal/classic helper tests; untestable-by-design list (QI-11-01). B-8 [#534](https://github.com/AccumuLatata/ThesisTester/pull/534) handler dispatch/payload tests for the nine QI-9 zero-mention IDs + `get_handler` (QI-09-04). B-9 [#535](https://github.com/AccumuLatata/ThesisTester/pull/535) CLI process tests for `__main__` and error paths + classic render helper stubs (QI-06-12). B-10 [#536](https://github.com/AccumuLatata/ThesisTester/pull/536) import-linter contracts C1–C5, C7–C10 warn-first (QI-12-07). B-11 [#537](https://github.com/AccumuLatata/ThesisTester/pull/537) mypy engine+analytics informational (QI-12-05). B-12 [#538](https://github.com/AccumuLatata/ThesisTester/pull/538) AppTest harness: no proto reads, enabled-only set_value, serial marker (QI-11-03). B-13 [#539](https://github.com/AccumuLatata/ThesisTester/pull/539) shared AppTest fixture + classic smoke (QI-10-05). B-14 [#540](https://github.com/AccumuLatata/ThesisTester/pull/540) narrow E402 ignore to `pages/1_Data.py` (QI-10-08). B-15 [#541](https://github.com/AccumuLatata/ThesisTester/pull/541) pytest markers warn-first (QI-11-05). B-16 [#542](https://github.com/AccumuLatata/ThesisTester/pull/542) replace no-raise accept tests (QI-11-06). B-17 [#543](https://github.com/AccumuLatata/ThesisTester/pull/543) ruff B family warn-first (QI-12-09). B-18 [#544](https://github.com/AccumuLatata/ThesisTester/pull/544) CAI realistic tick-gated fixture (QI-14-01). B-19 [#545](https://github.com/AccumuLatata/ThesisTester/pull/545) validation_summary four-key freeze + C9 sim_core (QI-05-13). G-4 [#546](https://github.com/AccumuLatata/ThesisTester/pull/546) bandit + pip-audit warn-first + SHA-pinned Actions (QI-12-06 / QI-07-09). G-5 [#547](https://github.com/AccumuLatata/ThesisTester/pull/547) devcontainer matches CI envelope (QI-12-08). C-1 [#548](https://github.com/AccumuLatata/ThesisTester/pull/548) `validate_setup_config` rule table (QI-03-03). C-2 [#549](https://github.com/AccumuLatata/ThesisTester/pull/549) `validate_run_spec` rule table (QI-06-01). C-3 [#550](https://github.com/AccumuLatata/ThesisTester/pull/550) `validate_study_spec` rule table (QI-07-03). C-4 [#551](https://github.com/AccumuLatata/ThesisTester/pull/551) Signals generate via `build_setup_config` (QI-03-10). C-5 [#552](https://github.com/AccumuLatata/ThesisTester/pull/552) `build_markdown_report` section table (QI-06-02). C-6 [#553](https://github.com/AccumuLatata/ThesisTester/pull/553) public analytics / hash helpers (QI-05-14, QI-06-11). C-7 [#554](https://github.com/AccumuLatata/ThesisTester/pull/554) research_bundle key registry (QI-06-04). C-8 [#555](https://github.com/AccumuLatata/ThesisTester/pull/555) Streamlit-free app_state split (QI-06-05). C-9 [#556](https://github.com/AccumuLatata/ThesisTester/pull/556) journal barrel import hygiene (QI-08-02). C-10 [#557](https://github.com/AccumuLatata/ThesisTester/pull/557) journal qty-scaled P&L helper (QI-08-01). C-11 [#558](https://github.com/AccumuLatata/ThesisTester/pull/558) execution_artifacts verify/publish/evict extract (QI-06-10). C-12 [#559](https://github.com/AccumuLatata/ThesisTester/pull/559) local_store sidecar policy helpers (QI-01-02). C-13 [#560](https://github.com/AccumuLatata/ThesisTester/pull/560) confluence_attribution summarizer split (QI-05-03). C-14 [#561](https://github.com/AccumuLatata/ThesisTester/pull/561) generate_signals phase extract (QI-03-01). C-15 [#562](https://github.com/AccumuLatata/ThesisTester/pull/562) generate_signals `iterrows` → column arrays (QI-14-05). C-16 [#563](https://github.com/AccumuLatata/ThesisTester/pull/563) shared 3c signal-row mapper (QI-03-02). C-17 [#564](https://github.com/AccumuLatata/ThesisTester/pull/564) walk_forward phase extract (QI-05-01). C-18 [#565](https://github.com/AccumuLatata/ThesisTester/pull/565) backtest skip/exit token constants (QI-04-09). C-19 [#566](https://github.com/AccumuLatata/ThesisTester/pull/566) simulate_trades P7 extract (QI-04-01). C-20 [#567](https://github.com/AccumuLatata/ThesisTester/pull/567) BarData float64 arrays (QI-14-09). C-21 [#568](https://github.com/AccumuLatata/ThesisTester/pull/568) results_overview claim-format tables (QI-09-01). C-22 [#569](https://github.com/AccumuLatata/ThesisTester/pull/569) caveats / corpus-score tables + `handle_results_turn` phases (QI-09-02). C-23 [#570](https://github.com/AccumuLatata/ThesisTester/pull/570) `run_study` phase helpers (QI-07-02). C-24 [#571](https://github.com/AccumuLatata/ThesisTester/pull/571) Observatory join / desk / lens + builder hydrate / emit (QI-07-07). C-25 [#572](https://github.com/AccumuLatata/ThesisTester/pull/572) journal match/report payload helpers (QI-08-04). D-1 [#573](https://github.com/AccumuLatata/ThesisTester/pull/573) research-key registry (QI-10-03). D-2 [#574](https://github.com/AccumuLatata/ThesisTester/pull/574) setup save/set-active clears session `signals` (QI-03-12). D-3 [#575](https://github.com/AccumuLatata/ThesisTester/pull/575) Backtest page helpers extract (QI-04-05). D-4 [#576](https://github.com/AccumuLatata/ThesisTester/pull/576) Validation helpers (QI-05-02). D-5 [#577](https://github.com/AccumuLatata/ThesisTester/pull/577) Data page upload/save extract (QI-01-01). D-6 [#578](https://github.com/AccumuLatata/ThesisTester/pull/578) Levels widget sync from `DEFAULT_LEVELS_SETTINGS` (QI-02-04). D-7 [#579](https://github.com/AccumuLatata/ThesisTester/pull/579) Setup Builder widget sync from `build_setup_config` (QI-03-04). D-8 [#580](https://github.com/AccumuLatata/ThesisTester/pull/580) Signals typed errors + render/sync split (QI-03-05). D-9 [#581](https://github.com/AccumuLatata/ThesisTester/pull/581) Studies Build section extract (QI-07-01). D-10 [#582](https://github.com/AccumuLatata/ThesisTester/pull/582) Assistant voice/sidecar + Advanced extract (QI-09-03). E-1 [#583](https://github.com/AccumuLatata/ThesisTester/pull/583) Levels Calculate `product_tick_family_preflight` (QI-02-03). E-2 [#584](https://github.com/AccumuLatata/ThesisTester/pull/584) Levels `ValueError` refuse without traceback expander (QI-02-05). E-3 [#585](https://github.com/AccumuLatata/ThesisTester/pull/585) CLI `run` `ValueError`/`OSError` → `EX_DATAERR`/`EX_NOINPUT` (QI-06-07). E-4 [#586](https://github.com/AccumuLatata/ThesisTester/pull/586) journal `--include-small-n` / `hidden_slice_count` include Q3 (QI-08-05). E-5 [#587](https://github.com/AccumuLatata/ThesisTester/pull/587) Assistant Draft `min_valid_confluences` allows AO1 `0` (QI-09-11). E-6 [#588](https://github.com/AccumuLatata/ThesisTester/pull/588) three-bar vocabulary on pages 12/14 (QI-09-10). E-7 [#589](https://github.com/AccumuLatata/ThesisTester/pull/589) Setup Builder naked any/all zone-level help (QI-03-09). E-8 [#590](https://github.com/AccumuLatata/ThesisTester/pull/590) Signals preview HTF/3c columns when non-null (QI-03-11). E-9 [#591](https://github.com/AccumuLatata/ThesisTester/pull/591) vectorize 15s→1m on-grid derive (QI-14-06). E-10 [#592](https://github.com/AccumuLatata/ThesisTester/pull/592) vectorize fixed-bracket sl_first P7 walk (QI-14-03). E-11 parked (CTO request only). F-5 [#593](https://github.com/AccumuLatata/ThesisTester/pull/593) ARCHITECTURE session-key Validation/Portfolio consumers (QI-13-04). F-9 [#594](https://github.com/AccumuLatata/ThesisTester/pull/594) strip file:line cites; AIA-0 names lazy st.secrets fallback (QI-13-06). F-10 (this PR) re-record CAI_BASELINE tick-gated tables (QI-14-02). Next: none (QR-F complete; E-11 parked). |
...
- Deterministic fixtures in `tests/fixtures/cai_baseline.py`:
  ...
  - `realistic` (780 bars / two RTH sessions, tick-gated `poc_windows=[]`) for
    informational timing only. Do not revive typical-price `_rolling_poc`.
...
- `tests/benchmarks/test_cai_cold_path.py` asserts small + realistic harness
  structure (six stage rows; tick-gated `poc_windows=[]`) and keeps the
  assistant parity fixture green.

### Observed baseline implication

CAI-0 recorded `compute_levels` ~71% of realistic e2e under typical-price
rolling POC. That path is gone (QI-14-01). F-10 re-recorded the live
tick-gated tables (`--fixture both`); isolated-stage share is
signal-dominated. CAI-10 still says no second signal cache yet.
CAI-2/CAI-3 still target verified levels-artifact reuse first.
...
- **CI** (`.github/workflows/ci.yml`), **blocking on red** (QR G-1 required
  status checks on `main`; QI-12-01 / QI-12-10 — a red required cell cannot merge):
  ...
  - Coverage is reported against a **warn-first** floor of **82%**
    (`COVERAGE_FLOOR` in `.github/workflows/ci.yml`; QI-12-04 / B-6). That is
    the QI-0 / QI-11 measured statement+branch line (35,598 stmts / 5,132
    missed; 14,994 branches / 3,117 partial at `e30cc48`). The R9 baseline was
    **88%**; the previous informational line was **85%**. The floor is still
    **not** a merge gate — `.github/workflows/ci.yml` does not pass
    `--cov-fail-under`, and `[tool.coverage.report]` does not set `fail_under`
...
- **Lint/format** — ruff rule set `E4`, `E7`, `E9`, `F`, `W`, plus **`B`**
  ...
  only (QI-10-08 / B-14; that page bootstraps `sys.path` before importing
  `thesistester`), `E741` for test fixtures using `l`/`O` bar shorthand,
  and noisy test `B` codes (`B009`/`B905`/`B017`/`B904`; `B023` stays on —
  a `B`/`B0`/`B02` prefix ignore must not swallow it). Equal-length
  invariant zips are `strict=True`; sliding-window and ragged `split("|")`
  pairs stay `strict=False`.
...
- `thesistester.engine.sim_core` owns immutable parent OHLC snapshots as
  write-protected ``float64`` arrays (C-20), one-bar bracket resolution,
  and the C-19 serial P7 walk / AH1 flatten cap. `BarData.at()` still
  returns Python floats. `simulate_trades` remains the sole public
  orchestrator of admission, skip/exit labels, costs, trade records,
  and diagnostics.
...
| TJ4 | **landed** — Daily recon (multiset + P&S + fees); 27-May redacted golden; CLI `journal reconcile` |
| TJ5 | **landed** — Join to 15s/1m clock (UTC); tick resolution when present; MAE/MFE only when `bars_held ≥ 1` |
...
## Journal → Study (JS0–JS4) — JS2 landed
...
| JS2 | **landed** — public `classify_zone_triggers` wrapper (delegates; no `_check_*` body edits); 1m + `15s_proxy` inference; Q3 Inferred trigger; CLI `journal triggers` |
