...
| Quality remediation (QR) | `docs/QUALITY_REMEDIATION_PLAN.md` (QR-A…QR-G) | **In progress** (Wave 1). Wave 0 complete (G-1 [#497](https://github.com/AccumuLatata/ThesisTester/pull/497)–G-3 [#501](https://github.com/AccumuLatata/ThesisTester/pull/501); F-1 [#502](https://github.com/AccumuLatata/ThesisTester/pull/502)–F-3 [#504](https://github.com/AccumuLatata/ThesisTester/pull/504)). A-1 [#505](https://github.com/AccumuLatata/ThesisTester/pull/505) Policy `allow_all` H5. A-2 (this PR) persists DA1 `direction_collision_diagnostic` on Backtest (QI-04-06). Next: **A-3**. |
