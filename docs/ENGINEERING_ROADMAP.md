...
rolling POC. That path is gone (QI-14-01). The live fixture is tick-gated;
F-10 re-records. CAI-2/CAI-3 still target verified levels-artifact reuse first.
