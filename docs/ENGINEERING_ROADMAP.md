...
| Trade journal (fills + intent ↔ FCM truth) | `docs/TRADE_JOURNAL_IMPLEMENTATION_PLAN.md` (TJ) | **TJ5 landed** (TJ0 locked, TJ1–TJ4 landed). 15s/1m bar join + optional tick resolution. Page 17 not in this PR. No engine/golden touch. Quantower *Trades* loader parked |
...
## Trade Journal (TJ0–TJ9) — TJ5 landed
