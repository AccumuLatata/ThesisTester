...
| Study Observatory (corpus UX) | `docs/STUDY_OBSERVATORY_IMPLEMENTATION_PLAN.md` (SO); operator `docs/STUDY_RUNNER.md` §SO | **SO4 shipped** (fact table + CLI + page 16 + Program B lens + saved desks). SO5 watch / SO6 Discuss parked. Read-only concat of existing study artifacts; no execute; no classic hydrate |
...
## Study Observatory (SO0–SO4) — SO4 shipped
