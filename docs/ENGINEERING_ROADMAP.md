...
| Level-combination research concept | `docs/LEVEL_COMBINATION_RESEARCH_CONCEPT.md` | **Program B** (docs-only, not executed). Holistic level-class × confluence-class design; B1 location-only vs B2 `dVWAP` lock; combination is the experiment. Does not amend the Notion desk lock page |
