...
| Study Observatory (corpus UX) | `docs/STUDY_OBSERVATORY_IMPLEMENTATION_PLAN.md` (SO); operator `docs/STUDY_RUNNER.md` §SO | **SO2 shipped** (fact table + CLI + `pages/16_Study_Observatory.py`). SO3–SO4 not started (Program B lens → saved desks). SO5 watch / SO6 Discuss parked. Read-only concat of existing study artifacts; no execute; no classic hydrate |
...
## Study Observatory (SO0–SO4) — SO2 shipped
