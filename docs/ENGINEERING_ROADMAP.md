...
| Help corpus coverage (feature/how-to docs) | `docs/HELP_CORPUS_COVERAGE_IMPLEMENTATION.md` (HC) | **In progress** — HC-0 ✅ (USER_GUIDE skeleton); HC-1…HC-4 remaining (allowlist + content + §1.1 retrieval) |
