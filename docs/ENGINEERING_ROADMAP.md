...
|---|---|---|
| Results discussion + product help | `docs/RESULTS_AND_PRODUCT_QA_IMPLEMENTATION.md` (RQ) | **Active** — RQ-0…RQ-2 implemented (Discuss + rankings); Help (RQ-3) / classic binding (RQ-4) pending |
