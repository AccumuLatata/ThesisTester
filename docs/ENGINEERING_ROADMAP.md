...
| Quality remediation (QR) | `docs/QUALITY_REMEDIATION_PLAN.md` (QR-A…QR-G) | **In progress** (Wave 0). G-1 [#497](https://github.com/AccumuLatata/ThesisTester/pull/497) required checks live; G-2 [#498](https://github.com/AccumuLatata/ThesisTester/pull/498) constraints + Dependabot; G-3 [#501](https://github.com/AccumuLatata/ThesisTester/pull/501) one install SoT. F-1 (this PR) is QI/CI docs truth. Next: F-2. |
