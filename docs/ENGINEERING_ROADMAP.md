...
| Discuss intelligence (recovery + expert framing) | `docs/DISCUSS_INTELLIGENCE_IMPLEMENTATION.md` (DI) | 🟡 **DI-0 plan frozen** — DI-1…DI-3 open (fail-closed numbers, fail-open discussion; no engine/golden touch) |
