...
| Quality remediation (QR) | `docs/QUALITY_REMEDIATION_PLAN.md` (QR-A…QR-G) | **In progress** (Wave 0 last docs PR). G-1 [#497](https://github.com/AccumuLatata/ThesisTester/pull/497) required checks live; G-2 [#498](https://github.com/AccumuLatata/ThesisTester/pull/498) constraints + Dependabot; G-3 [#501](https://github.com/AccumuLatata/ThesisTester/pull/501) one install SoT. F-1 [#502](https://github.com/AccumuLatata/ThesisTester/pull/502) QI/CI docs truth; F-2 [#503](https://github.com/AccumuLatata/ThesisTester/pull/503) README seven triggers; F-3 (this PR) docs index / shelves (QI-13-05). After merge: Wave 0 complete → **A-1**. |
