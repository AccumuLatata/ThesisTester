...
| Help corpus coverage (feature/how-to docs) | `docs/HELP_CORPUS_COVERAGE_IMPLEMENTATION.md` (HC) | **Proposed** — widen USER_GUIDE + §7.1 allowlist so Help can explain all primary features (HC-0…HC-4) |
