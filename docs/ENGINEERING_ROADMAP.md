...
| Duplex intelligence (realtime content parity) | `docs/DUPLEX_INTELLIGENCE_IMPLEMENTATION.md` (DX) | 🟡 **DX-0…DX-1 ✅ / DX-2 in flight** — DI envelopes + `has_overview_negative_cue` + realtime/results §4.3 instruction needles; DX-3 eval freeze pending; voice default remains off |
