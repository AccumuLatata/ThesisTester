...
| Research Study Runner | `docs/STUDY_RUNNER_IMPLEMENTATION_PLAN.md` (RS); operator `docs/STUDY_RUNNER.md` | ✅ **RS1–RS5 MVP + RS-D7**; post-MVP remaining **RS6 → RS-D2 → RS-D4 → RS-D5** (plan-locked) |
...
| RS6 | Default-off registered `STUDY.*` capabilities (handlers refuse when off) + minimal CLI/confirm docs ☐ **next** |
