...
| Help corpus coverage (feature/how-to docs) | `docs/HELP_CORPUS_COVERAGE_IMPLEMENTATION.md` (HC) | **In progress** — HC-0✅ HC-1✅ (Data→Backtest + allowlist + §1.1); HC-2…HC-4 remaining |
