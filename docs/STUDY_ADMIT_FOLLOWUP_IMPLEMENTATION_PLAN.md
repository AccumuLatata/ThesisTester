...
**Date:** 2026-08-18  
**Status:** **SAF3 this PR (`--tod-group` / `--allow-thin` + catalog parent). SAF0–SAF2 landed. SAF4 parked.**  
...
| **SAF3** | `--tod-group` / `--allow-thin` + catalog `parent` | CLI + briefing group_col + viewer catalog field (this PR) |
