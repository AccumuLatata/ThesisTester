...
- [STUDY_OBSERVATORY_IMPLEMENTATION_PLAN.md](STUDY_OBSERVATORY_IMPLEMENTATION_PLAN.md) (SO — corpus fact table + facets + cohort lock + Program B lens; **SO1 shipped** (compiler + CLI); SO2–SO4 not started; SO5/SO6 parked; does not reopen SV Inspect or execute)
