...
- [ROLLING_POC_QUANTOWER_INVESTIGATION_PLAN.md](ROLLING_POC_QUANTOWER_INVESTIGATION_PLAN.md) (RP — `POC_rolling_*` is default tick Last×Volume; no QT sliding oracle; missing ticks → all-NaN; not a Quantower rolling-widget claim)
