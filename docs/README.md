...
- [STUDY_ADMIT_FOLLOWUP_IMPLEMENTATION_PLAN.md](STUDY_ADMIT_FOLLOWUP_IMPLEMENTATION_PLAN.md) (SAF — Admit follow-up draft from a completed study; SAF1 CLI `--admit-tod auto` shipped; SAF2 Inspect button / SAF3 hour+thin not started; does not auto-run or add a ToD factor axis)
