...
- [DIRECTIONAL_INTEGRITY_IMPLEMENTATION_PLAN.md](DIRECTIONAL_INTEGRITY_IMPLEMENTATION_PLAN.md) (DA — Directional Attribution; **not** Discuss Intelligence DI. `touch` + `both` + `single_position` is a long-only sample; **DA5 landed**; DA6 not started; no existing-golden regen)
