...
- [STUDY_OBSERVATORY_IMPLEMENTATION_PLAN.md](STUDY_OBSERVATORY_IMPLEMENTATION_PLAN.md) (SO — corpus fact table + facets + cohort lock + Program B lens + saved desks + studies pane + cohort labels; **SO1–SO4 + SO7–SO8 shipped**; **SO9 planned**; SO5/SO6 parked; does not reopen SV Inspect or execute)
