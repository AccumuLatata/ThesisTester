...
| [JOURNAL_TO_STUDY_IMPLEMENTATION_PLAN.md](JOURNAL_TO_STUDY_IMPLEMENTATION_PLAN.md) | JS — journal zones / trigger inference / StudySpec proposal; **JS0 locked**; Gate A can stop after JS2 |
...
- [JOURNAL_TO_STUDY_IMPLEMENTATION_PLAN.md](JOURNAL_TO_STUDY_IMPLEMENTATION_PLAN.md) (JS — zone attribution + engine-trigger inference + frequency-selected StudySpec with `holdout` + rule-vs-desk; **JS0 locked**; no 15s trigger lane; no golden regen)
