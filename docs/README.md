...
- [ROLLING_POC_QUANTOWER_INVESTIGATION_PLAN.md](ROLLING_POC_QUANTOWER_INVESTIGATION_PLAN.md) (RP — Quantower parity for `POC_rolling_30min`; **RP0 locked**; allocation is 1m typical; AP1 tick scorecard does not transfer; RP2 tick opt-in is no-go until a written rolling-window oracle)
