...
- [STUDY_VIEWER_IMPLEMENTATION_PLAN.md](STUDY_VIEWER_IMPLEMENTATION_PLAN.md) (SV — Studies Inspect catalog / quality / charts / cell peek; SV0–SV3 ✅; SV4 not started; does not reopen RS-D2 execute/session boundaries)
