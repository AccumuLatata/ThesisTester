...
- [STUDY_INGEST_ALIGNMENT_IMPLEMENTATION_PLAN.md](STUDY_INGEST_ALIGNMENT_IMPLEMENTATION_PLAN.md) (SIA — Studies authoring aligns to 15s-primary `run_experiment`; SIA0 plan-locked; does not change engine/Data/execute)
