...
- [DIRECTIONAL_INTEGRITY_IMPLEMENTATION_PLAN.md](DIRECTIONAL_INTEGRITY_IMPLEMENTATION_PLAN.md) (DA — Directional Attribution; **not** Discuss Intelligence DI. `touch` + `both` + `single_position` is a long-only sample; **DA4 landed**; DA5–DA6 not started; no existing-golden regen)
