...
- [CONFLUENCE_COMBO_ATTRIBUTION_PLAN.md](CONFLUENCE_COMBO_ATTRIBUTION_PLAN.md) (combo attribution Views A–C + Phase 6 direction × combo; **Phase 6 implemented**; successor of archived `anchor_confluence_regression_safe_plan.md`)
