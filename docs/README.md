...
- [STUDY_RUNNER_IMPLEMENTATION_PLAN.md](STUDY_RUNNER_IMPLEMENTATION_PLAN.md) (RS — MVP RS1–RS5 ✅; post-MVP §12: RS6→D7→D2→D4→D5)
- [STUDY_RUNNER.md](STUDY_RUNNER.md) (RS operator contract; RS1–RS5 MVP complete)
