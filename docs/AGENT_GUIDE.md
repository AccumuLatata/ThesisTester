...
**SO (SO4 shipped):** Study Observatory —
...
under `{store}/study_observatory/desks`. Reuse `discover_study_dirs`.
Do not implement SO5/SO6 inside an RS/SV/SAF PR. Do not call `report_study`
