...
- **Tick VAP (TV):** `docs/TICK_VAP_IMPLEMENTATION_PLAN.md` (TV1–TV3 landed; TV4 widgets/Help pending). Tick-last ingest for prior VA only; no ticks → those nine columns absent; do not retick VWAP / OR / 3c.
