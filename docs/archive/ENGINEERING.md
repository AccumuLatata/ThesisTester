...
> **ARCHIVED (historical Draft v0.1, 2026-06-03).** Not a living status source.
> Living successors: [`../ARCHITECTURE.md`](../ARCHITECTURE.md),
> [`../ENGINEERING_ROADMAP.md`](../ENGINEERING_ROADMAP.md),
> [`../ENGINEERING_PROPOSAL.md`](../ENGINEERING_PROPOSAL.md) §4.
> Voice sidecar ops extracted to [`../VOICE_SIDECAR_OPS.md`](../VOICE_SIDECAR_OPS.md).

*Intraday confluence-setup backtesting & research app (Streamlit + Python)*

**Status:** Archived historical draft · **Owner:** AccumuLatata · **Last updated:** 2026-06-03
...
├── requirements.txt
├── docs/archive/ENGINEERING.md         # this file
└── README.md
```
...
> **Moved.** Living ops: [`../VOICE_SIDECAR_OPS.md`](../VOICE_SIDECAR_OPS.md).
