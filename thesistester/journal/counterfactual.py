...
C-25 (QI-08-04) keeps walk math here and moves bracket-summary / row-frame
helpers to ``counterfactual_tables.py``. Walks already-loaded 15s bars /
Last prints. Does not call ``simulate_trades``.
"""
...
from thesistester.journal.counterfactual_tables import (
    _cf_frame,
    summarize_bracket_replay,
