...
| `dopen_ma_3c_mnq.yaml` | **8** | dOpen × EMA21/SMA50 (1m, 5m), 3c on 1m, MNQ. Grid on ($40 / $500 cap, $0.50/side). Replace `dataset.path` if the Quantower CSV moves. Time-of-day R is post-run (`run_time_analysis`), not a factor axis. |
