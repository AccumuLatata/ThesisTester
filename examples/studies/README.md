...
Study Viewer (catalog + `study list` + quality panes shipped as SV1–SV2; charts / peek are SV3–SV4): [`docs/STUDY_VIEWER_IMPLEMENTATION_PLAN.md`](../../docs/STUDY_VIEWER_IMPLEMENTATION_PLAN.md)  
