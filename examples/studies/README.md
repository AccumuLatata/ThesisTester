...
Study Viewer (catalog + `study list` + quality panes + overview charts shipped as SV1–SV3; cell peek is SV4): [`docs/STUDY_VIEWER_IMPLEMENTATION_PLAN.md`](../../docs/STUDY_VIEWER_IMPLEMENTATION_PLAN.md)  
